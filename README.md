...
The [B2C Commerce Hostname Aliases Cheat Sheet](ALIASES.md) explains settings precedence, API-specific outbound host selection, parser and importer failure behavior, overloaded terminology, entry-point ordering, copyable ownership patterns, redirect limitations, and the storefront verification matrix behind those examples.
