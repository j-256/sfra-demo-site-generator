...
// skipped - and it also skips compound already-suffixed text such as "RefArchGlobalJ" or
// "RefArchSharedLibraryJ" (there the next char is "G" or "S", a case a suffix-specific lookahead
