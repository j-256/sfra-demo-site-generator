...
export function transformFileContent(xml, rename, { isSiteXml = false, siteName = null, rebrand = false } = {}) {
  ...
  if (rebrand) {
    ...
    // library-id are already suffixed and never seen as prose here; attribute values are never
    ...
    // it is idempotent AND leaves already-suffixed compound text (e.g. "RefArchGlobalJ",
