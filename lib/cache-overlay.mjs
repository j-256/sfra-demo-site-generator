...
// always emitted, because an importing instance stores all three and merely OBEYS the one matching
// its own role - there is no way to ship "just the staging setting". Omitting an environment
// therefore means explicitly turning caching OFF there, not leaving it alone
